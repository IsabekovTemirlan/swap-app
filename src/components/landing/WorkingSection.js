        ...
        <section className="pb-20 bg-gray-100 -mt-32">
            <div className="container max-w-7xl mx-auto px-4">
                <div className="flex flex-wrap relative z-50">
                    <StatusCard color="red" icon="add" title="Добавить">
                        Добавьте свой товар, который
                        хотите обменять на другой,
                    ...
                    <StatusCard
                        ...
                        title="Найти"
                    >
                        Найдите товары в нашем
                        "Каталоге обмена" и предложите
                        обменяться
                    </StatusCard>
                    <StatusCard
                        color="teal"
